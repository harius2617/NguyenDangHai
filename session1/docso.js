...
let ngan = ['khong ngan','mot ngan','hai ngan','ba ngan','bon ngan','nam ngan','sau ngan','bay ngan','tam ngan','chin ngan']
...
console.log(123455, readNumber(123455))
console.log(123405, readNumber(123405))
console.log(1234, readNumber(1234))